...
export function ModuleModal({ isOpen, onClose, title, children, lang, maxWidth = "max-w-5xl" }: ModuleModalProps) {
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className={cn(
        ...
        <div className="relative w-full bg-white rounded-[48px] overflow-hidden flex flex-col max-h-[92vh]">
          {/* Modal Header */}
